...
print(Image.open(img_name_vector[0]))
...
print(f'img_name_train length = {len(img_name_train)}')
print(f'cap_train length = {len(cap_train)}')
print(f'img_name_val length = {len(img_name_val)}')
print(f'cap_val length = {len(cap_val)}')
