...
You will use the [MS-COCO dataset](http://cocodataset.org/#home) to train your model. The dataset contains over 82,000 images, 
each of which has at least 5 different caption annotations. The code below downloads and extracts the dataset automatically.
...
img_list = ['https://tensorflow.org/images/surf.jpg',
            'http://people.csail.mit.edu/brussell/research/LabelMe/Images/05june05_static_indoor/p1010843.jpg',
            'http://people.csail.mit.edu/brussell/research/LabelMe/Images/indoor_static_20apples/cimg1291.jpg']
...
for i in range(len(img_list)):
    ...
    print('Prediction Caption:', ' '.join(result))
    # result_es = reloaded.tf_translate(result)
    # print('Prediction Caption Translated:', ' '.join(result_es))
